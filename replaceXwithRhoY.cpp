      ...
      char* argv[])
{
    ...
    const int nCompOut = idYout + nSpec;
    ...
    for (int i=0; i<nSpec; ++i)
    {
        ...
        outNames[i] = "rho.Y(" + cd.speciesNames()[i] + ")";
    }
    destFillComps[nSpec] = nSpec;
    inNames[nSpec] = "density";
    ...
    std::string nfile(getFileRoot(plotFileName) + "_RhoY");
