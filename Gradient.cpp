      ...
      char* argv[])
{
    ...
    Array<std::string> InvarNames(4);
    int Nlev = finestLevel +1; 
    InvarNames[0] = "x_velocity";
    InvarNames[1] = "y_velocity";
    InvarNames[2] = "z_velocity";
    InvarNames[3] = "temp";
    int nCompIn = 4;
...
//        geoms[lev].FillPeriodicBoundary(inState,0,nCompIn,do_corners);
 ...
 bool verb=false;
  const AmrData& a = amrData;
   bool append = true ; 
   appendToPlotFile(amrData, outState, plotFileName, nnames,"Vel_GradT",0);
